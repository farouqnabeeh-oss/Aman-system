    ...
    <header className="relative h-16 flex items-center justify-between px-4 lg:px-6 flex-shrink-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-100">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="lg:hidden flex items-center justify-center w-9 h-9 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 hover:text-brand"
        >
          <Menu size={18} />
        </button>

        {/* Breadcrumb path pill */}
        <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-100 text-xs text-slate-400">
      ...
      <button
        ...
        className="flex items-center gap-3 w-full max-w-xs mx-4 px-4 py-2.5 rounded-xl text-slate-400 cursor-pointer transition-all duration-200 hover:text-brand hover:bg-slate-50 border border-slate-100 group"
      >
        ...
        <div className="hidden sm:flex items-center gap-1">
          <kbd className="h-5 px-1.5 rounded-md text-[9px] font-mono text-slate-300 flex items-center gap-0.5 border border-slate-100 bg-white">
            <Command size={9} />K
          </kbd>
        </div>
      </button>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center w-9 h-9 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 hover:text-brand transition-all"
        ...
        {/* Notifications */}
        <Link href="/notifications" className="relative flex items-center justify-center w-9 h-9 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 hover:text-brand transition-all">
          <Bell size={16} />
          <AnimatePresence>
            {unread > 0 && (
              <motion.span
          ...
          <button
            ...
            className={clsx(
              ...
              dropdownOpen
                ...
                : 'bg-slate-50 border-slate-100 hover:border-brand/10'
            )}
          >
            ...
            <ChevronDown size={12} className={clsx('text-slate-400 transition-transform', dropdownOpen && 'rotate-180')} />
          </button>
          ...
          <AnimatePresence>
            {dropdownOpen && (
              <motion.div
                ...
                className={clsx(
                  'absolute top-full mt-2 w-52 rounded-2xl p-2 z-50 bg-white border border-slate-100 shadow-2xl',
              ...
              >
                ...
                <div className="h-px bg-slate-50 mb-1" />
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-rose-500 hover:bg-rose-50 transition-all text-xs font-black uppercase tracking-widest"
                >
